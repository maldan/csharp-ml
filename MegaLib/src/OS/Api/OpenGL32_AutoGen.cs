...
// 
  [DllImport("opengl32.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
  public static extern void glTexImage2D(GLenum target, GLint level, GLint internalformat, GLsizei width,
    GLsizei height, GLint border, GLenum format, GLenum type, IntPtr data);

// 
  [DllImport("opengl32.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
  public static extern void glTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width,
    GLsizei height, GLenum format, GLenum type, IntPtr pixels);

// 
  [DllImport("opengl32.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
  public static extern void glTextureSubImage2D(GLuint texture, GLint level, GLint xoffset, GLint yoffset,
    GLsizei width, GLsizei height, GLenum format, GLenum type, IntPtr pixels);
...
// 
  public static void glVertexAttribPointer(GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride,
    IntPtr pointer)
  {
    GetProcedure<glVertexAttribPointerDelegate>("glVertexAttribPointer")(index, size, type, normalized, stride,
      pointer);
  }

  private delegate void glVertexAttribPointerDelegate(GLuint index, GLint size, GLenum type, GLboolean normalized,
    GLsizei stride, IntPtr pointer);
...
// 
  ...
  private delegate void glVertexAttribIPointerDelegate(GLuint index, GLint size, GLenum type, GLsizei stride,
    IntPtr pointer);
...
// 
  ...
  private delegate void glVertexAttribLPointerDelegate(GLuint index, GLint size, GLenum type, GLsizei stride,
    IntPtr pointer);
...
// 
  ...
  private delegate void
    glGetShaderInfoLogDelegate(GLuint shader, GLsizei maxLength, ref GLsizei length, IntPtr infoLog);
...
// 
  public static void glFramebufferTexture2D(GLenum target, GLenum attachment, GLenum textarget, GLuint texture,
    GLint level)
  {
    GetProcedure<glFramebufferTexture2DDelegate>("glFramebufferTexture2D")(target, attachment, textarget, texture,
      level);
  }

  private delegate void glFramebufferTexture2DDelegate(GLenum target, GLenum attachment, GLenum textarget,
