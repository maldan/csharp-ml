...
namespace MegaLib.AssetLoader.GLTF
{
  public class GLTF_Accessor
  {
    ...
    public List<Vector4Int> Vec4Int()
    {
      var view = ViewData();
      var outData = new List<Vector4Int>();
      ...
      for (var i = 0; i < Count; i++)
      {
        switch (ComponentType)
        {
          case GLTF.COMPONENT_TYPE_UINT8:
            outData.Add(new Vector4Int(reader.ReadByte(), reader.ReadByte(), reader.ReadByte(), reader.ReadByte()));
            break;
          case GLTF.COMPONENT_TYPE_UINT16:
            outData.Add(new Vector4Int(reader.ReadInt16(), reader.ReadInt16(), reader.ReadInt16(), reader.ReadInt16()));
            break;
          case GLTF.COMPONENT_TYPE_UINT32:
            outData.Add(new Vector4Int(reader.ReadInt32(), reader.ReadInt32(), reader.ReadInt32(),
              reader.ReadInt32()));
            break;
          default:
